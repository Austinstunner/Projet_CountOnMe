...
protocol LogicalDelegate: class {
...
final class Logical {
    ...
    enum ErrorCase {
        case operationImpossible, operationHaveResult, wrongOperator, divideByZero, decimalExist, memorize, syntax
        var title: String {
            switch self {
        ...
        var message: String {
            ...
            case .operationHaveResult: return "This operation have a result. Press M to Keep last result or AC to clear"
            ...
            case .memorize: return "Nothing to memorize"
